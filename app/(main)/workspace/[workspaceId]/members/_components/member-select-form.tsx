...
const MemberSelectForm = ({
  ...
  const onSubmit: SubmitHandler<FormData> = async (values) => {
    try {
      ...
      // await addMember(workspaceId, values.email, values.user_id);
      // form.reset();
      // toast("Member Added");
      // router.refresh();
      ...
      if (result === "User already exists in the workspace") {
        toast("User already exists in the workspace");
      } else {
        form.reset();
        toast("Member Added");
        router.refresh();
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription>
                Once submitted the user will be added to this workspace.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
